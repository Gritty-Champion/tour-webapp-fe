...
import { dammyDataIconic } from "../../../data/packages";




export const IcoicPackages = ({getnamePackages}) => {
  let settings = {
    dots: true,
    infinite: false,
    speed: 500,
              ...
              {dammyDataIconic.map(value =>{
                ...
                <div className="card_content m-2">
                  ...
                  <div className="btn_buy px-4 ">
                    <button className="w-full bg-primary py-1 rounded-xl text-base text-white" onClick={() => getnamePackages(value.uniqueId)}>
                      Buy Now
                    </button>
                  </div>
                </div>
