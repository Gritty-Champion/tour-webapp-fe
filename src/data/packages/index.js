...
//   },
 ...
 description: [
    `See the best of Downtown NYC in a fun and convenient way with our Hop on Hop off tour. Our open top buses offer stunning views of the city, and you can hop on and hop off at any stop to explore at your own pace.`,
    `Our tour guides will provide you with informative commentary about the city as you travel, and you can also listen to audio commentary in your choice of 15+ languages.`,
      `Our Hop-on Hop-off tour is the perfect way to see Downtown and learn about its history and culture. Book your tickets today and start your adventure!`,
 ],
...
//   },
 ...
 description: [
    `Experience incredible views of the Statue of Liberty on our cruise, offering unparalleled photo
    ...
    `With our premium package, enjoy priority boarding and guaranteed seating for optimal comfort. Your
    Statue of Liberty Cruise Premium admission also includes a complimentary glass of sparkling wine or a
    soft drink, paired with a delicious cookie.`,
    `Onboard, explore all decks of the vessel, capturing the perfect selfie or group photo with the Statue of
    Liberty as your backdrop. Secure your tickets now for an unforgettable experience aboard the best
    Statue of Liberty Cruise in NYC.`
 ],
...
export let dammyDataDoubleBus = [
...

  {
    ...
    description: [
      `The All City Iconic Express Tour is a great way to see the most popular tourist attractions in a city in a short amount of time. The tour typically takes about 2-3 hours and includes stops at some of the city’s most iconic landmarks, such as the Statue of Liberty, the Empire State Building, and the Golden Gate Bridge. The tour is narrated by a knowledgeable guide who will provide you with interesting facts and history about the city.`,
      `The All-City Iconic Express Tour is a great option for first-time visitors to a city who want to see the highlights without having to worry about transportation or finding their way around. A tour is also a good option for families with young children or for people with limited mobility.`,
    ],
    featurePass: [
